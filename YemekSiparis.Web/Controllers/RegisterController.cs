			...
			if (ModelState.IsValid)
			{
				if (appUserRegisterDTO.KullanimSartlari == true)
				{
					...
					if (result.Succeeded)
					{
						...
						MailboxAddress mailboxAddressFrom = new MailboxAddress("YemekSepetiAdmin", "dproje.5@outlook.com");
						...
						bodyBuilder.HtmlBody = @"<!DOCTYPE html>
									 ...
									 <head>
										 ...
										 <title>Boost Burger Hesap Doğrulama</title>
										 <style>
											body {
									...
									<body>
										<div class='container'>
											<h2>Boost Burger Hesap Doğrulama</h2>
											<p>Merhaba,</p>
											<p>Boost Burger hesabınızı doğrulamak için aşağıdaki doğrulama kodunu kullanın:</p>
						...
						mimeMessage.Subject = "Boost Burger Onay Kodu";

						SmtpClient client = new SmtpClient();
						client.Connect("smtp.office365.com", 587, false);
						client.Authenticate("dproje.5@outlook.com", "123456789aA*");
